...
def start(message):
    ...
    if if_user_is_new(current_user_id):
        add_new_user_to_db(current_user_id, message.chat.first_name, message.chat.last_name )
        ...
        last_code_saved_in_db = get_selection_of_building_from_db_by_teleg_id(current_user_id, "bill_code")
        print ("get_selection_of_building_from_db_by_teleg_id(current_user_id) = " + str(last_code_saved_in_db) )
        ...
        text_to_send_registered_user = text_to_send_registered_user.format(first_name_of_current_user,
                                                                           get_selection_of_building_from_db_by_teleg_id(current_user_id, "bill_code"))
...
def func(message):
    building_you_selected = "some_def_value"
    message_chat_id = message.chat.id
    current_user_id = message.chat.id
    ...
    # ====Avan6 worksheet 2 -------------------------------------------------
        ...
        temp_val = Find_Dept_By_Code(x, current_user_id)
    ...
    # print(type(x))
    elif (x.isnumeric() == True) and get_selection_of_building_from_db_by_teleg_id(  current_user_id, "f_n_p") == "flat":
        print("numeric")
...
"""
                    ...
                    current_billcode_in_db = get_selection_of_building_from_db_by_teleg_id(current_user_id, "bill_code")
    ...
    # building_you_selected_v2 = get_selection_of_building_from_db_by_teleg_id(message_chat_id, "col1")
    ...
    elif (x.isnumeric() == True) and get_selection_of_building_from_db_by_teleg_id(current_user_id, "f_n_p") == "nkugh" and current_val_of_building_from_db_by_teleg_id != "uknown" or ( #  building_you_selected != "uknown"  - > this must be fixed to understand when this is happpeneing..
            x.isnumeric() == True) and get_selection_of_building_from_db_by_teleg_id(  current_user_id, "f_n_p")== "parking" and current_val_of_building_from_db_by_teleg_id != "uknown":
        ...
        dutytopay = Find_Dept_By_Code(combined_code, current_user_id)
        ...
        if dutytopay == "myundefined":
            ...
            update_bill_code_for_given_user_to_db(current_user_id, dutytopay)
            ...
            if (get_selection_of_building_from_db_by_teleg_id(  current_user_id, "f_n_p") == "nkugh"):
                tmp_text1 = "նկուղի"
            elif get_selection_of_building_from_db_by_teleg_id(  current_user_id, "f_n_p") == "parking":
                tmp_text1 = "կայանատեղիի"


            get_selection_of_building_from_db_by_teleg_id(  current_user_id, "f_n_p")
...
"""
    ...
    #     print("we are in section of parking - this block doesn't really required." )
        ...
        last_bill_code_saved_in_db = get_selection_of_building_from_db_by_teleg_id(current_user_id, "bill_code")
        ...
        if get_firstletter_of_code == "A":
            ...
            dept_for_this_user_in_google_doc = Find_Dept_By_Code(last_bill_code_saved_in_db, current_user_id)
