...
def func(message):
    ...
    if(message.text == "55/17"):
        ...
        bot.send_message(message.chat.id, text="Hello, please choose one of these buttons:  :) ".format(message.from_user), reply_markup=markup)





        print("user should slect  ->btn1_flat or btn2_nkugh btn3_parking , considering that building_you_selected  55/17   was chosen" )
...
# ------------------------------settings.nkugh_parking_flat == "nkugh":settings.nkugh_parking_flat == "nkugh":settings.nkugh_parking_flat == "nkugh":settings.nkugh_parking_flat == "nkugh":settings.nkugh_parking_flat == "nkugh
    ...
    elif (x.isnumeric()==True) and settings.nkugh_parking_flat == "nkugh" or (x.isnumeric()==True) and settings.nkugh_parking_flat == "parking":
...
#u should continue from here, 000000000000000000000000000000000000000000 find cell by entered Num - > find in selected worksheet - you have that .
        ...
        if len(building_you_selected)==10 and x>0 and x < 108:   # Avan6 55/3 and not ->  ---Avan6 55/33 Avan6 55/34
            ...
            dutytopay = Find_Code_By_address(3, x, 3 )
            update_new_user_to_db(current_user_id, settings.Cell_To_Find)
            ...
            if selected_worksheet_for_nkugh_parking ==0 or selected_worksheet_for_nkugh_parking == 2:
                settings.Cell_To_Find = "A-55" + str(get_kototak_from_selection) + "-" + str(x)
            elif selected_worksheet_for_nkugh_parking == 1 or selected_worksheet_for_nkugh_parking == 3:
                print("nkuhg or kayanateghi")
                if settings.nkugh_parking_flat == "nkugh":
            ...
            print(Find_Dept_By_Code(settings.Cell_To_Find))
...
# =====================================---
            ...
            print("block with     elif (x.isnumeric()==True) and settings.nkugh_parking_flat == nkugh  ")
    ...
    elif (x.isnumeric()==True) and settings.nkugh_parking_flat == "parking":
        print("we are in section of parking" )
