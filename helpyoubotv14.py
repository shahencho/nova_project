...
"""
    ...
    # ------------------------------settings.nkugh_parking_flat == "nkugh":settings.nkugh_parking_flat == "parking"  - if nkugh_parking_flat ==flat it will cover on above IF else , not here, this peace only for nkuga and parking.
    ...
    elif (x.isnumeric() == True) and settings.nkugh_parking_flat == "nkugh" and building_you_selected != "uknown" or ( #  building_you_selected != "uknown"  - > this must be fixed to understand when this is happpeneing..
        ...
        building_you_selected_v2 = get_selection_of_building_from_db_by_teleg_id(message_chat_id, "col1")
        print('elif (message.text == "Բնակարան"    get_selection_of_building_from_db_by_teleg_id(message_chat_id, "col1") = ', building_you_selected_v2  )
...
# ===============================================================
    ...
    # select Nkugh part_ՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղ
        ...
        building_you_selected_v2 = get_selection_of_building_from_db_by_teleg_id(message_chat_id, "col1")
        print('elif (message.text == "Նկուղ"    get_selection_of_building_from_db_by_teleg_id(message_chat_id, "col1") = ', building_you_selected_v2  )
        ...
        building_you_selected_v2 = get_selection_of_building_from_db_by_teleg_id(message_chat_id, "col1")
        print('elif (message.text == "Կայանատեղի"    get_selection_of_building_from_db_by_teleg_id(message_chat_id, "col1") = ', building_you_selected_v2  )
