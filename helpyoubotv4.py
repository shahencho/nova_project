...
def func(message):
    ...
    if(message.text == "55/17"):
       ...
       # please select what do you want flat/nkukh/parking
        ...
        bot.send_message(message.chat.id, text="Hello, you have selected this building  " + str(message.text) + "now you should slect what do u want - > please choose one of these buttons:  :) ", reply_markup=markup)

        print("user should slect  ->btn1_flat or btn2_nkugh btn3_parking , considering that building_you_selected  55/20   was chosen" )
   ...
   # ====Avan6 worksheet 2 -------------------------------------------------
       ...
       # please select what do you want flat/nkukh/parking
        ...
        print("user should slect  ->btn1_flat or btn2_nkugh btn3_parking , considering that building_you_selected  Avan6 55/33   was chosen" )
        print(building_you_selected)
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
       ...
       # please select what do you want flat/nkukh/parking
        ...
        print("user should slect  ->btn1_flat or btn2_nkugh btn3_parking , considering that building_you_selected  Avan6 55/34   was chosen" )
        print(building_you_selected)
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
...
# ------------------------------settings.nkugh_parking_flat == "nkugh":settings.nkugh_parking_flat == "nkugh":settings.nkugh_parking_flat == "nkugh":settings.nkugh_parking_flat == "nkugh":settings.nkugh_parking_flat == "nkugh
    ...
    elif (x.isnumeric()==True) and settings.nkugh_parking_flat == "nkugh" and building_you_selected != "uknown" or (x.isnumeric()==True) and settings.nkugh_parking_flat == "parking" and  building_you_selected != "uknown":
...
#u should continue from here, 000000000000000000000000000000000000000000 find cell by entered Num - > find in selected worksheet - you have that .
        ...
        if dutytopay == "myundefined":
            ...
            back = types.KeyboardButton("return to home menu")
            markup.add(back)
            bot.send_message(message.chat.id, text = " Code is not found - > you may request another 'Nkugh' within {" + building_you_selected + "}  or press button and go to home page ", reply_markup=markup)
    ...
    # ======================
            print (building_you_selected)
            # bot.send_message(message.chat.id, text="for this flat you must pay .")
            text_to_print = " Dear Customer , for building {} and Nkugh/Parking number {}  "
            temp_text ="uknownnnn"
            temp_text = text_to_print.format(building_you_selected,int(x))
            ...
            back = types.KeyboardButton("return to home menu")
            markup.add(back)
            bot.send_message(message.chat.id, text = " you may request another 'Nkugh' within {" + building_you_selected + "}  or press button and go to home page ", reply_markup=markup)
...
# =====================================---
    ...
    #     print("we are in section of parking - this block doesn't really required." )
        ...
        if dept_for_this_user_in_google_doc != "99999999":
            ...
            print(building_you_selected)
            # bot.send_message(message.chat.id, text="for this flat you must pay .")
            text_to_print = " Dear Customer , for building {} and flat/nkugh/Parking  number {}  "
            temp_text = "uknownnnn"
    ...
    # select bnakaran part_---------------------------------------bnakaranbnakaranbnakaranbnakaranbnakaranbnakaranbnakaranbnakaranbnakaranbnakaran
        ...
        bot.send_message(message.chat.id, text="ok, Avan4 55/20 ->  i will need your Բնակարան  number  please )")
    ...
    # select Nkugh part_ՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղՆկուղ
        ...
        bot.send_message(message.chat.id, text="ok, " + str(building_you_selected) + ' ' + str(settings.selected_worksheet_is) +  "  ->  i will need your nkugh Համար    please ")
        ...
        bot.send_message(message.chat.id, text="ok, " + str(building_you_selected) + ' ' + str(settings.selected_worksheet_is) +  "  ->  i will need your Կայանատեղի  number  please ")
