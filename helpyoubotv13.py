...
def Find_Code_By_address(message_chat_id,kotorak, bnak_hamar, worksheet_sequence):
    ...
    if worksheet_sequence == 0 or worksheet_sequence == 2:
        ...
        print("get_selection_of_building_from_db_by_teleg_id                     \n")
...
def func(message):
    ...
    if (message.text == "55/17"):
        ...
        update_selection_of_building_to_db(current_user_id, building_you_selected ) #save this selection to DB in column col1
    ...
    # print(type(x))
        ...
        print('get_selection_of_building_from_db_by_teleg_id(message_chat_id, "col1") = ', building_you_selected_v2  )
        ...
        if int(x) < 281 and (
            ...
            if dutytopay != "99999999":
                ...
                temp_text = "uknownnnn"
                temp_text = text_to_print.format(get_day_date_from_google_doc, building_you_selected[6:], int(x))
