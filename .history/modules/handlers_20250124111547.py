...
INFO:handlers:Customer properties fetched: {'firstName': 'Արսեն', 'lastName': 'Նալբանդյան', 'middleName': 'Գագիկի', 'phoneNumber': '37494777513', 'email': 'Arsen_nalbandyan@mail.ru', 'customerProperties': [{'apartment': '48 շենք', 'number': '2', 'code': 'A-48-2', 'type': 'Բնակարան'}, {'apartment': 'կայանատեղի 50/1', 'number': '2', 'code': 'P-501-2', 'type': 'Կայանատեղի'}, {'apartment': 'կայանատեղի 50/1', 'number': '7', 'code': 'P-501-7', 'type': 'Կայանատեղի'}]}
