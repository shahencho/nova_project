    ...
    if validation_response and "customerProperties" in validation_response:
        ...
        for prop in properties:
            ...
            if details:
                ...
                apartment = details.get("apartment", "N/A")
                type_of_object = details.get("type", "N/A")   


                current_code = details.get("code", 0)
                # Generate financial status message
                status_message = generate_financial_status_message(code, deposit, debt, apartment, type_of_object)
