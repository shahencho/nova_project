...
from api_helpers import fetch_deposit_and_debt_from_api, fetch_customer_properties, fetch_debt_for_code, fetch_property_details, generate_financial_status_message, generate_financial_status_message2
...
async def display_properties(validation_response, update):
    ...
    INFO:database_operations:validation_response >>>>>>>>>  {'firstName': 'Մերի', 'lastName': 'Տեր-Հարությունովա', 'middleName': 'Դավթի', 'phoneNumber': '37491995901', 'email': '', 'customerProperties': [{'apartment': '48 շենք', 'number': '1', 'code': 'A-48-1', 'type': 'Բնակարան'}]}
