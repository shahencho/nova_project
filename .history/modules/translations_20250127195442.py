TRANSLATIONS = {
    ...
    "found_objects": "Ընտրեք գույքը՝ վճարումների պատմությունը դիտելու համար։",
    ...
    # "case_debt_no_deposit": "{code} Դուք ունեք պարտք, պարտքի գումարը՝ {debt} դրամ։ Խնդրում ենք հնարավորինս շուտ կատարել վճարումը։",
    "case_no_debt_with_deposit": "{code} Դուք ունեք կանխավճար, գումարը՝ {deposit} դրամ։ Շնորհակալություն ժամանակին վճարումները կատարելու և մեզ վստահելով՝ կանխավճար վճարելու համար։",
