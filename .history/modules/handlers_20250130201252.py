...
from menu_helpers import Change_Assosiate_mobile, get_main_menu, display_blady_button,get_objects_menu
import logging
import time
    ...
    try:
        ...
        if user_input == TRANSLATIONS["change_mobile"]:
            ...
            if validation_result == "not_valid_format":
                await update.message.reply_text("Invalid mobile number format. Use +374xxxxxxxx or 0xxxxxxxx.")
                return
            elif validation_result == "valid_not_registered_in_API":
                await update.message.reply_text("Mobile not registered. Use a valid registered number.")
                return
        ...
        #     await update.message.reply_text("step1_mobile_register_succesfully Available options: choose buttons below")
            ...
            await update.message.reply_text(
                "Available options: choose buttons below"
            )
            return  # Don't restart
